...
export const fa: Messages = {
  ...
  header: {
    ...
    modeMockHint:
      'کلید TYPESAFE_API_KEY تنظیم نشده است، بنابراین پاسخ‌های نمونهٔ قطعی برگردانده می‌شود.',
    modeUnknownHint: 'ارتباط با API برقرار نشد، بنابراین حالت آن نامشخص است.',
  },

  form: {
    heading: 'ثبت تیکت',
    subheading: 'فارسی یا انگلیسی. در حالت آزمایشی هیچ‌چیزی از دستگاه شما خارج نمی‌شود.',
    title: 'عنوان',
